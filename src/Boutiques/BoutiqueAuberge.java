...
public class BoutiqueAuberge {
    ...
    * @since 1.0
    */
    public void boutiqueAuberge(Personnage perso) throws IOException{
        System.out.println("\nBienvenue dans l'auberge !");
        prix =(int)((perso.getVieAcutelle()-perso.getVie())/10);
        ...
        while(!continuer){
            ...
            if(this.choix.equals("o")){
                ...
                if(perso.getArgent()-prix < 0){
                   ...
                   perso.setVie(perso.getVieAcutelle());
