...
/**
 * <p>
 * <strong>Cette classe permet la création du menu de combats.</strong></p>
 *
 * @author Jérémy Duval
 * @since 1.0
 */
public class Combat {
    ...
    /**
     * <p>
     * Cette fonction détermine un rang de monstre en fonction du lieu ainsi que
     * son type (aléatoirement entre 3).</p>
     *
     * @param lieu : Lieu
    ...
    /**
     * <p>
     * Cette fonction est le menu représentant les différentes possibilité du
    ...
    /**
     * <p>
     * Cette fonction représente le tour du monstre pendant le Combat.</p>
     *
     * @author Jérémy Duval
     * @param treePerso : TreeMap (String,Personnage) : tout les objets
     * personnages
    ...
    public Monstres combatMob(TreeMap<String, Personnage> treePerso, String perso, ArmeUtilise arme, Monstres mob) {
        ...
        } else if ((nb_aleat > mob.getProbaAtq()) && (nb_aleat < 11)) {
    ...
    /**
     * <p>
     * Cette fonction sert à faire passer de niveau de l'arme.</p>
     *
     * @author Jérémy Duval
     * @param treePerso : TreeMap (String,Personnage) : tout les objets
     * personnages
    ...
    /**
     * <p>
     * Cette fonction sert à faire passer de niveau le perso.</p>
     *
     * @author Jérémy Duval
     * @param treePerso : TreeMap (String,Personnage) : tout les objets
     * personnages
    ...
    /**
     * <p>
     * Cette fonction sert à faire distribuer des points de caractéristique.</p>
     *
     * @author Jérémy Duval
     * @param treePerso : TreeMap (String,Personnage) : tout les objets
     * personnages
    ...
    /**
     * <p>
     * Cette fonction sert à augmenter l'xp et l'argent du perso lorsqu'il a
     * vaincu le monstre.</p>
     *
     * @author Jérémy Duval
     * @param treePerso : TreeMap (String,Personnage) : tout les objets
    ...
    /**
     * <p>
     * Cette fonction détermine si le perso trouve un item (ainsi que sa valeur)
