...
/**
 * <p>
 * <strong>Cette classe abstraite définie les types de personnages.</strong></p>
 *
 * @author Jérémy Duval
 * @since 1.0
 */
public abstract class Personnage implements Serializable {
    ...
    /**
     * <p>
     * <Strong>Ce constructeur permet d'initialiser tout les stats du personnage
    ...
    /**
     * <p>
     * Cette méthode renvoie le level du perso.</p>
     *
     * @return int : level
     * @author Jérémy Duval
     * @since 1.0
    ...
    /**
     * <p>
     * Cette méthode renvoie la vie du perso.</p>
     *
     * @return int : vie
     * @author Jérémy Duval
     * @since 1.0
    ...
    /**
     * <p>
     * Cette méthode renvoie la vie actuelle du perso.</p>
     *
     * @return int : vie_actu
     * @author Jérémy Duval
     * @since 1.0
    ...
    /**
     * <p>
     * Cette méthode renvoie les pm du perso.</p>
     *
     * @return int : pm
     * @author Jérémy Duval
     * @since 1.0
    ...
    /**
     * <p>
     * Cette méthode renvoie l'attaque du perso.</p>
     *
     * @return int : atq
     * @author Jérémy Duval
     * @since 1.0
    ...
    /**
     * <p>
     * Cette méthode renvoie l'attaque magique du perso.</p>
     *
     * @return int : atq_mag
     * @author Jérémy Duval
     * @since 1.0
    ...
    /**
     * <p>
     * Cette méthode renvoie la defense du perso.</p>
     *
     * @return int : def
     * @author Jérémy Duval
     * @since 1.0
    ...
    /**
     * <p>
     * Cette méthode renvoie la defense magique du perso.</p>
     *
     * @return int : def_mag
     * @author Jérémy Duval
     * @since 1.0
    ...
    /**
     * <p>
     * Cette méthode renvoie l'agilité du perso.</p>
     *
     * @return int : agilite
     * @author Jérémy Duval
     * @since 1.0
    ...
    /**
     * <p>
     * Cette méthode renvoie l'intelligence du perso.</p>
     *
    ...
    /**
     * <p>
     * Cette méthode renvoie la sagesse du perso.</p>
     *
     * @return int : sagesse
     * @author Jérémy Duval
     * @since 1.0
    ...
    /**
     * <p>
     * Cette méthode renvoie les points d'xp du perso.</p>
     *
     * @return int : xp
     * @author Jérémy Duval
     * @since 1.0
    ...
    /**
     * <p>
     * Cette méthode renvoie les point d'xp nécessaire pour passer au niveau
     * suivant.</p>
     *
     * @return int : xp_nec
     * @author Jérémy Duval
    ...
    /**
     * <p>
     * Cette méthode renvoie l'argent du perso.</p>
     *
     * @return int : argent
     * @author Jérémy Duval
     * @since 1.0
    ...
    /**
     * <p>
     * Cette méthode renvoie la valeur de l'épée du perso.</p>
     *
    ...
    /**
     * <p>
     * Cette méthode renvoie la valeur du sceptre du perso.</p>
     *
    ...
    /**
     * <p>
     * Cette méthode renvoie la valeur du talisman du perso.</p>
     *
    ...
    /**
     * <p>
     * Cette méthode renvoie la valeur de la potion de vie du perso.</p>
     *
    ...
    /**
     * <p>
     * Cette méthode renvoie la valeur de l'armure du perso.</p>
     *
    ...
    /**
     * <p>
     * Cette méthode renvoie la valeur de l'armure magique du perso.</p>
     *
    ...
    /**
     * <p>
     * Cette méthode renvoie le type d'arme utilisable par le perso. Ce type est
     * implémenté par l'interface {@link Arme}</p>
     *
     * @return String : arme
     * @author Jérémy Duval
     * @since 1.0
    ...
    /**
     * <p>
     * Cette méthode renvoie le nom du type d'arme utilisé par le perso. Ce type
     * est implémenté par l'interface {@link ArmeUtilise}</p>
     *
     * @return String
     * @author Jérémy Duval
     * @since 1.0
    ...
    /**
     * <p>
     * Cette méthode renvoie le type d'arme utilisé par le perso. Ce type est
     * implémenté par l'interface {@link ArmeUtilise}</p>
     *
     * @return Arme
     * @author Jérémy Duval
     * @since 1.0
    ...
    /**
     * <p>
     * Cette méthode renvoie la valeur de l'arme utilisé par le perso. Ce type
     * est implémenté par l'interface {@link ArmeUtilise}</p>
     *
     * @return int
     * @author Jérémy Duval
    ...
    /**
     * <p>
     * Cette méthode renvoie le niveau à l'épée du perso.</p>
     *
     * @return int
     * @author Jérémy Duval
     * @since 1.0
    ...
    /**
     * <p>
     * Cette méthode renvoie le niveau au sceptre du perso.</p>
     *
     * @return int
     * @author Jérémy Duval
     * @since 1.0
    ...
    /**
     * <p>
     * Cette méthode renvoie le niveau au talisman du perso.</p>
     *
     * @return int
     * @author Jérémy Duval
     * @since 1.0
    ...
    /**
     * <p>
     * Cette méthode renvoie l'xp de l'épée du perso.</p>
     *
     * @return int
     * @author Jérémy Duval
     * @since 1.0
     */
    public int getXpEpee() {
        return xp_arme.get("Epee");
    }

    /**
     * <p>
     * Cette méthode renvoie l'xp du sceptre du perso.</p>
     *
     * @return int
     * @author Jérémy Duval
     * @since 1.0
     */
    public int getXpSceptre() {
        return xp_arme.get("Sceptre");
    }

    /**
     * <p>
     * Cette méthode renvoie l'xp du talisman du perso.</p>
     *
     * @return int
     * @author Jérémy Duval
     * @since 1.0
     */
    public int getXpTalisman() {
        return xp_arme.get("Talisman");
    }

    /**
     * <p>
     * Cette méthode renvoie l'xp nécéssaire au level suivant de l'épée du
     * perso.</p>
     *
     * @return int
     * @author Jérémy Duval
     * @since 1.0
     */
    public int getXpNecessaireEpee() {
        return xp_nec_arme.get("Epee");
    }

    /**
     * <p>
     * Cette méthode renvoie l'xp nécéssaire au level suivant du sceptre du
     * perso.</p>
     *
     * @return int
     * @author Jérémy Duval
     * @since 1.0
     */
    public int getXpNecessaireSceptre() {
        return xp_nec_arme.get("Sceptre");
    }

    /**
     * <p>
     * Cette méthode renvoie l'xp nécéssaire au level suivant du talisman du
     * perso.</p>
     *
     * @return int
     * @author Jérémy Duval
     * @since 1.0
     */
    public int getXpNecessaireTalisman() {
        return xp_nec_arme.get("Talisman");
    }

    /**
     * <p>
     * Cette méthode renvoie la classe du perso.</p>
     *
     * @return int
     * @author Jérémy Duval
     * @since 1.0
    ...
    /**
     * <p>
     * Cette méthode renvoie le type de sort du perso. Ce type est implémenté
     * par l'interface {@link Sort}</p>
     *
     * @return Sort
     * @author Jérémy Duval
     * @since 1.0
    ...
    /**
     * <p>
     * Cette méthode renvoie un Map contenant les valeurs, pour chaque
     * caracéristique, à aditionner avec l'ancienne lors du passage de
     * level.</p>
     *
     * @return Map
     * @author Jérémy Duval
    ...
    /**
     * <p>
     * Cette méthode change le level du perso ainsi que les xp nécessaires au
     * prochain level.</p>
     *
    ...
    /**
     * <p>
     * Cette méthode change la vie du perso.</p>
     *
    ...
    /**
     * <p>
     * Cette méthode change la vie actuelle du perso.</p>
     *
    ...
    /**
     * <p>
     * Cette méthode change les pm du perso.</p>
     *
    ...
    /**
     * <p>
     * Cette méthode change l'attaque du perso.</p>
     *
    ...
    /**
     * <p>
     * Cette méthode modifie la defense du perso.</p>
     *
    ...
    /**
     * <p>
     * Cette méthode modifie la defense magique du perso.</p>
     *
    ...
    /**
     * <p>
     * Cette méthode modifie l'agilité du perso.</p>
     *
    ...
    /**
     * <p>
     * Cette méthode modifie l'intelligence du perso.</p>
     *
    ...
    /**
     * <p>
     * Cette méthode modifie la sagesse du perso.</p>
     *
    ...
    /**
     * <p>
     * Cette méthode modifie les points d'xp du perso.</p>
     *
    ...
    /**
     * <p>
     * Cette méthode modifie l'argent du perso.</p>
     *
    ...
    /**
     * <p>
     * Cette méthode modifie la valeur de l'épée du perso.</p>
     *
    ...
    /**
     * <p>
     * Cette méthode modifie la valeur du sceptre du perso.</p>
     *
    ...
    /**
     * <p>
     * Cette méthode modifie la valeur du talisman du perso.</p>
     *
    ...
    /**
     * <p>
     * Cette méthode modifie la valeur de la potion de vie du perso.</p>
     *
    ...
    /**
     * <p>
     * Cette méthode modifie la valeur de la potion de pm du perso.</p>
     *
    ...
    /**
     * <p>
     * Cette méthode modifie la valeur de l'armure du perso.</p>
     *
    ...
    /**
     * <p>
     * Cette méthode modifie la valeur de l'armure magique du perso.</p>
     *
    ...
    /**
     * <p>
     * Cette méthode modif l'arme utilisé par le perso. Ce type est implémenté
     * par l'interface {@link ArmeUtilise}</p>
     *
     * @param new_arme : Arme
     * @param new_val : int
     * @author Jérémy Duval
    ...
    /**
     * <p>
     * Cette méthode change le niveau à l'épée du perso.</p>
     *
    ...
    /**
     * <p>
     * Cette méthode change le niveau au sceptre du perso.</p>
     *
    ...
    /**
     * <p>
     * Cette méthode change le niveau au talisman du perso.</p>
     *
    ...
    /**
     * <p>
     * Cette méthode change l'xp de l'épée du perso.</p>
     *
     * @author Jérémy Duval
     * @param nxp_epee : int
     * @since 1.0
     */
    public void setXpEpee(int nxp_epee) {
        xp_arme.remove("Epee", xp_arme.get("Epee"));
        xp_arme.put("Epee", nxp_epee);
    }

    /**
     * <p>
     * Cette méthode change l'xp du sceptre du perso.</p>
     *
     * @param nxp_sceptre : int
     * @author Jérémy Duval
     * @since 1.0
     */
    public void setXpSceptre(int nxp_sceptre) {
        xp_arme.remove("Sceptre", xp_arme.get("Sceptre"));
        xp_arme.put("Sceptre", nxp_sceptre);
    }

    /**
     * <p>
     * Cette méthode change l'xp du talisman du perso.</p>
     *
     * @param nxp_talisman : int
     * @author Jérémy Duval
     * @since 1.0
     */
    public void setXpTalisman(int nxp_talisman) {
        xp_arme.remove("Talisman", xp_arme.get("Talisman"));
        xp_arme.put("Talisman", nxp_talisman);
    }
    ...
    /**
     * <p>
     * Cette méthode calcul le nombre d'XP necessaire au prochain level.</p>
     *
    ...
    /**
     * <p>
     * Cette méthode calcul le nombre d'XP necessaire au prochain level de
     * l'arme.</p>
     *
     * @return Int : nombre d'XP nécessaire au passage du prochain niveau.
     * @author Jérémy Duval
    ...
    /**
     * <p>
     * Cette méthode renvoie le contenu de l'inventaire.</p>
     *
    ...
    public String toInventaire() {
        return "*********************************\nInventaire :\n*********************************\nEpee : "
                + this.getEpee() + "\nNiveau à l'épée : " + this.getLevelEpee()
                + "\nXp : " + this.getXpEpee() + "/" + this.getXpNecessaireEpee()
                + "\nSceptre : " + this.getSceptre() + "\nNiveau au sceptre : " + this.getLevelSceptre()
                + "\nXp : " + this.getXpSceptre() + "/" + this.getXpNecessaireSceptre()
                + "\nTalisman : " + this.getTalisman() + "\nNiveau au talisman : " + this.getLevelTalisman()
                + "\nXp : " + this.getXpTalisman() + "/" + this.getXpNecessaireTalisman()
